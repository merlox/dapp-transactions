   ...
   render(){
      return (
         <header>
            ...
            <Link to="/"><img src={LINKS.baseUrl + 'img/logo.png'} className="header-logo"/></Link>
            ...
            <nav>
               ...
               <Link className={this.state.currentSection === 'triple-entry' ? 'active-header' : ''} to={LINKS.home}>Triple Entry</Link>
               <Link className={this.state.currentSection === 'team' ? 'active-header' : ''} to="#">Team</Link>
               <Link to="#" className="log-out-button">
                  Log out
                  <img src={LINKS.baseUrl + 'img/icon.png'} className="log-out-button-icon"/>
               </Link>
            </nav>
